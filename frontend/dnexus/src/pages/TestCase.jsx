...
function TestCase() {
  ...
  //             setrad2ConsentMessage("Rad1 Consent is Accepted");
  //             setrad2Show(true);
  ...
  //             setrad2ConsentMessage("rad1 Consent is Pending");
  //           }

  //           else if (!firstOrSecondConditionMet && entity.entityType === "RADIOLOGIST" && entity.consentStatus === "REJECT") {
  //             setrad2ConsentStatusReject(true);
  //             console.log("consent reject",rad2ConsentStatusReject);
  //             setrad2ConsentMessage("rad1 Consent is Rejected. Please select another rad1");
  //             setrad2Added(false);
  //             setrad2Show(false);
  //           }
  //         });
