...
//     const { consultationName, test } = formData;
//     // const { professionalDocId } = localStorage.getItem('actorId');
//     // const professionalDocId = JSON.parse(localStorage.getItem('actorId')).professionalDocId;

//     const actorId = JSON.parse(localStorage.getItem('actorId'));
// const professionalDocId = actorId ? actorId.professionalDocId : null;
...
//         <span className="close" onClick={onClose}>&times;</span>
//         <h2>Create Case</h2>
//         {/* Add the <form> tag to properly connect the form */}
//         <form onSubmit={handleSubmit}>
//           <div className='form-input'>
//             <label>Case Name:</label>
//             <input
